...
public class DashboardActivity extends AppCompatActivity implements View.OnClickListener{
    private CardView cleaningCardView ;
    String EmailHolder;
    TextView Email;
    Button LogOUT ;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cleaningCardView = findViewById(R.id.cleaningCardViewId);
       Email = (TextView)findViewById(R.id.textView1);
        LogOUT = (Button)findViewById(R.id.button1);

        cleaningCardView.setOnClickListener((View.OnClickListener)this);
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.cleaningCardViewId){

            Intent intent = new Intent(DashboardActivity.this,Cleaning.class);
            startActivity(intent);
        }
    }
}